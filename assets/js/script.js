...
// Dirubah 
const pengirim = "Cacaa tinggi";
const nomorWa = "6281646881706" // awalan nomor 0 harus di awalin 62
const textWa = "akuuuu sayanggggg kamuuuu!!!"
const pesan = `makasiii ayangggg buatt waktu selamaa inii, makasiii yaaaaa udaa selaluu adaaa buattt akuuu dann selaluu nemeninnn akuuuu sampaiii saaat inii, akuuu bersyukurr bangetttt punyaaa kamuuu... samaaa akuuuu terusss okeeeeiiiii??? loveee youuuu ayanggggg `;
...
hilang1.addEventListener('click', () => {
  ...
  Swal.fire({
    ...
    imageHeight: 120,
    title: 'ayangggggg ayanggggg tauuuu gaaaa kapann tanggall jadiannn kitaaa??',
    html: `<input type="text" id="login" class="swal2-input" placeholder="tanggal/bulan/tahun">`,
    confirmButtonText: 'Kirim',
    focusConfirm: false,
    preConfirm: () => {
      const login = Swal.getPopup().querySelector('#login').value
      if (!login) {
        Swal.showValidationMessage(`issss masaaa gatauuuu ayangggggg`)
      }
      return { login }
    }
  }).then((result) => {
    ...
    let txt = `benerrr ayanggggg!!! aahhahhaahaa kitaaa udaaaa mauuuu setahunn yaaaaaaa ${pesan}`;
